...
docs.to_csv("../resources/antique/antique_docs.csv", index=False)
queries.to_csv("../resources/antique/antique_queries.csv", index=False)
qrels.to_csv("../resources/antique/antique_qrels.csv", index=False)

docs = pd.read_csv("../resources/antique/antique_docs.csv")
queries = pd.read_csv("../resources/antique/antique_queries.csv")
...
def clean_queries(queries):
    ...
    queries = queries.fillna('')
    queries.to_csv("../resources/antique/antique_queries_clean.csv", index=False)
...
def clean_docs(docs):
    ...
    docs = docs.fillna('')
    docs.to_csv("../resources/antique/antique_docs_clean.csv", index=False)
    print("Clean docs end in : " + str(datetime.datetime.now()))


if __name__ == '__main__':
    clean_queries(queries)  # to clean queries      (takes about some seconds)
    clean_docs(docs)  # to clean docs         (takes about 3 hours)
